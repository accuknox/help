...
![Rule condition dropdown showing Has Tickets, Unique Vulnerability Name, Location, Is New, and Tool Output](./images/release-notes/v3.5/rule-engine-conditions-dropdown-1.png)

![Rule condition dropdown showing Risk Factor, Exploit Available, Asset Name, Tags, and Asset Category](./images/release-notes/v3.5/rule-engine-conditions-dropdown-2.png)

![Rule condition dropdown showing Compliance Name, Ignored, Asset Groups, Finding ID, Asset Tags, and Last Fixed](./images/release-notes/v3.5/rule-engine-conditions-dropdown-3.png)

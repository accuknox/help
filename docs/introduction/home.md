...
<div class="main-container">
  <div class="content-container">
    <div class="text-container">
      <article class="header1">Welcome to Help Center</article>
    </div>
  ...
  <div class="use-cases-grid">
    <div class="use-cases-category">
      ...
      <ul class="use-cases-list">
        <li><a href="/use-cases/iac-scan/">IaC Scan AWS S3 Buckets (CI/CD Pipeline)</a></li>
        <li><a href="/use-cases/sast-sq/">SAST + SQL Injection</a></li>
        <li><a href="/use-cases/container-scan/">ASPM Container Scan</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Container Security (CWPP)</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/image-scan/">Container Image Scan</a></li>
        <li><a href="/use-cases/app-hardening/">Runtime Application Hardening</a></li>
        <li><a href="/use-cases/hardening/">Workload Hardening</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Securing Secrets Manager (CWPP)</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/hashicorp/">HarshiCorp Vault Hardening</a></li>
        <li><a href="/use-cases/cyberark-conjur/">CyberArk Conjur Hardening</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Least Permissive Posture Assessment (CWPP)</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/app-behavior/">Runtime Application Behaviour Discovery</a></li>
        <li><a href="/use-cases/forensics/">Audit/Forensics</a></li>
        <li><a href="/use-cases/zero-trust/">Zero trust Security</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Host Security (CWPP)</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/host-sec/">Host Scan</a></li>
        <li><a href="/use-cases/malware-scan/">Malware Scan</a></li>
        <li><a href="/use-cases/vm-hardening/">VM Hardening</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Cloud Security (CSPM)</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/asset-inventory/">Asset Inventory</a></li>
        <li><a href="/use-cases/cloud-misconfigurations">Cloud Misconfiguration and Drift Detection</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Automation</p>
      <ul class="use-cases-list">
        <li><a href="/resources/ticket-procedure/">Ticketing</a></li>
        <li><a href="/use-cases/">Rules Engine</a></li>
      </ul>
    </div>
    <div class="use-cases-category">
      <p class="use-cases-category-title">Prioritization</p>
      <ul class="use-cases-list">
        <li><a href="/use-cases/">EPSS Scoring</a></li>
      </ul>
    </div>
  </div>
  <button class="all-use-cases">
  <a href="/use-cases/cnapp-security-overview">VIEW ALL USE CASES <img src="../cards/arrow-white.svg" style="width: 1rem; margin-bottom:-5px; margin-left: 5px; color: white;"></a>
</button>
</div>
</section>
...
<div class="integrations-container">
 ...
 <div class="text-container">
   ...
   <a href="/integrations/jira-cloud/">GET STARTED</a>
   </button>
 </div>
</div>
</section>
  ...
  <div class="section5-container">
    ...
    <p class="section5-description">Empower your security team with the product knowledge they need to maximize the value of your solution.</p>
        <div class="section5-card-container">
            ...
            <a href="https://accu-knox.atlassian.net/servicedesk/customer/portal/1" class="section5-card-link">CONNECT WITH US &rarr;</a>
            </div>
          <div class="section5-card">
            ...
            <a href="https://www.accuknox.com/certifications" class="section5-card-link">GET CERTIFIED &rarr;</a>
          </div>
          <div class="section5-card">
            ...
            <a href="/resources/accuknox-manual/" class="section5-card-link">DOWNLOAD NOW &rarr;</a>
          </div>
        </div>
  </div>
</section>

...
- [Prompt Firewall Browser Plugin](#prompt-firewall-browser-plugin-chrome-firefox-safari-brave-and-edge)
- [Red Teaming Custom Models via Collector](#red-teaming-custom-models-via-collector)
- [AI App Inventory: Managed Agents, Models, and Unmanaged Assets](#ai-app-inventory-managed-agents-models-and-unmanaged-assets)
...
- [KubeArmor: Per-Node CRI Auto-Detection](#kubearmor-per-node-cri-auto-detection)
- [KubeArmor PTS Rule Support](#kubearmor-pts-rule-support)
- [KubeArmor Network Enforcement](#kubearmor-network-enforcement)
...
![AI Security Dashboard showing agent counts across Azure and AWS with agents by cloud provider and severity, connected knowledge bases and tools, and model inventory](./images/release-notes/v3.5/ai-inventory-managed-assets-dashboard.png)
...
![Managed agent list filtered by cloud provider with a detail pane for an individual Bedrock AgentCore agent showing metadata, memory configuration, and timeline](./images/release-notes/v3.5/ai-inventory-managed-agents-view.png)
...
![Unmanaged assets grouped by category showing AI Agent, AI Gateway, AI Inference Engine, AI-ML, AI SDK, and MCP with asset counts and findings](./images/release-notes/v3.5/ai-inventory-unmanaged-assets-discovery.png)
...
See the [KubeArmor network policy specification](https://docs.kubearmor.io/kubearmor/documentation/network_security_policy_specification) and [network policy examples](https://docs.kubearmor.io/kubearmor/documentation/network_security_policy_examples) for the full policy schema.

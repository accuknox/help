...
- **references/REF RFPs folder** — H&M, CNA, SABIC, Rakuten (if available), NSA Kubernetes Hardening Guide responses
...
- **references/PDFs/** folder — reference content and security collateral

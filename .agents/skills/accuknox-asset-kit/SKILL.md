...
- Keep to the length the brief sets (default under 1500 words) and the
  `AGENTS.md` style rules (no dashes, plain words).
...
- [ ] Writing follows the no-AI-tells style rules in `AGENTS.md` (no dashes, no "leverage/ensure/robust/seamless", plain sentences).
